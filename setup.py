...
import numpy  # Unfortunately we need numpy.get_include()
...
def write_pxi(settings):
    """ Write out config.pxi file according to command line or environment
        variable settings.
    """
...
"""
    ...
    # We skip updating the file if contents match, to avoid a Cython rebuild
    if newcontents != oldcontents:
        with open(localpath('h5py/config.pxi'),'wb') as f:
            f.write(newcontents)
    else:
        print("config: no change")
