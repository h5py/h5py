...
cdef class CacheConfig:
    ...
    def rpt_fcn_enabled(self, hbool_t val) -> None:
    ...
    def evictions_enabled(self, hbool_t val) -> None:
    ...
    def set_initial_size(self, hbool_t val) -> None:
        self.cache_config.set_initial_size = val

    @property
    def initial_size(self) -> size_t:
        return self.cache_config.initial_size

    @initial_size.setter
    def initial_size(self, size_t val) -> None:
        self.cache_config.initial_size = val

    @property
    def min_clean_fraction(self) -> double:
        return self.cache_config.min_clean_fraction

    @min_clean_fraction.setter
    def min_clean_fraction(self, double val) -> None:
    ...
    @max_size.setter
    def max_size(self, size_t val) -> None:
        self.cache_config.max_size = val

    @property
    def min_size(self) -> size_t:
        return self.cache_config.min_size

    @min_size.setter
    def min_size(self, size_t val) -> None:
    ...
    @epoch_length.setter
    def epoch_length(self, long int val) -> None:
    ...
    @incr_mode.setter
    def incr_mode(self, H5C_cache_incr_mode val) -> None:
        self.cache_config.incr_mode = val

    @property
    def lower_hr_threshold(self) -> double:
        return self.cache_config.lower_hr_threshold

    @lower_hr_threshold.setter
    def lower_hr_threshold(self, double val) -> None:
    ...
    @increment.setter
    def increment(self, double val) -> None:
    ...
    def apply_max_increment(self, hbool_t val) -> None:
        self.cache_config.apply_max_increment = val

    @property
    def max_increment(self) -> size_t:
        return self.cache_config.max_increment

    @max_increment.setter
    def max_increment(self, size_t val) -> None:
    ...
    def flash_incr_mode(self, H5C_cache_flash_incr_mode val) -> None:
        self.cache_config.flash_incr_mode = val

    @property
    def flash_multiple(self) -> double:
        return self.cache_config.flash_multiple

    @flash_multiple.setter
    def flash_multiple(self, double val) -> None:
        self.cache_config.flash_multiple = val

    @property
    def flash_threshold(self) -> double:
        return self.cache_config.flash_threshold

    @flash_threshold.setter
    def flash_threshold(self, double val) -> None:
    ...
    @decr_mode.setter
    def decr_mode(self, H5C_cache_decr_mode val) -> None:
        self.cache_config.decr_mode = val

    @property
    def upper_hr_threshold(self) -> double:
        return self.cache_config.upper_hr_threshold

    @upper_hr_threshold.setter
    def upper_hr_threshold(self, double val) -> None:
        self.cache_config.upper_hr_threshold = val

    @property
    def decrements(self) -> double:
        return self.cache_config.decrement

    @decrements.setter
    def decrements(self, double val) -> None:
    ...
    def apply_max_decrement(self, hbool_t val) -> None:
        self.cache_config.apply_max_decrement = val

    @property
    def max_decrement(self) -> size_t:
        return self.cache_config.max_decrement

    @max_decrement.setter
    def max_decrement(self, size_t val) -> None:
    ...
    def epochs_before_eviction(self, int val) -> None:
    ...
    def apply_empty_reserve(self, hbool_t val) -> None:
        self.cache_config.apply_empty_reserve = val

    @property
    def empty_reserve(self) -> double:
        return self.cache_config.empty_reserve

    @empty_reserve.setter
    def empty_reserve(self, double val) -> None:
    ...
    def dirty_bytes_threshold(self, int val) -> None:
