...
class TestExcaliburLowLevel(unittest.TestCase):
    ...
    def test_excalibur_low_level(self):
        ...
        print("stripe: ", vdset_stripe_shape)
        print("max stripe: ", vdset_stripe_max_shape)
        vdset_shape = (5,
        ...
        vdset_max_shape = (5,
                           ...
                           excalibur_data.fem_stripe_dimensions[1])
        vdset_y_offset = 0
        print("VDS shape: ", vdset_shape)
        print("VDS max: ", vdset_max_shape)
