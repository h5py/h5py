...
#define COMPLEX256_SUPPORT 0
#else
#define COMPLEX256_SUPPORT {int(hasattr(numpy, 'complex256'))}
#endif

#endif
"""
        write_if_changed(localpath('h5py', 'config.h'), header_s)
        write_if_changed(
            localpath('h5py', 'config.h', root=build_path), header_s)
